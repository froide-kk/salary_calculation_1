...
class ResultsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create result" do
    assert_difference('Result.count') do
      post results_url, params: { result: { name: @result.name, result_id: @result.result_id } }
    end
  ...
  test "should update result" do
    patch result_url(@result), params: { result: { name: @result.name, result_id: @result.result_id } }
