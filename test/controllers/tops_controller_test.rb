...
class TopsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create top" do
    assert_difference('Top.count') do
      post tops_url, params: { top: { age: @top.age, emp_id: @top.emp_id, name: @top.name, pay: @top.pay } }
    end
  ...
  test "should update top" do
    patch top_url(@top), params: { top: { age: @top.age, emp_id: @top.emp_id, name: @top.name, pay: @top.pay } }
